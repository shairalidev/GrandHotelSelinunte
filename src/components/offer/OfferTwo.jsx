            ...
            <div className="rts__section offer__area is__home__one has__shape">
                ...
                <div className="container">
                    ...
                    <div className="row row-60">
                        {/* single offer item */}
                        <div className="col-xl-6 col-lg-10 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        {/* single offer item */}
                        <div className="col-xl-6 col-lg-10 wow fadeInUp" data-wow-delay=".4s">
                            <div className="single__offer">
                                <div className="single__offer__image">
                                    <img
                        ...
                        {/* single offer item end */}
                        {/* single offer item */}
                        <div className="col-xl-6 col-lg-10 wow fadeInUp" data-wow-delay=".5s">
                            <div className="single__offer">
                                <div className="single__offer__image">
                                    <img
                        ...
                        {/* single offer item end */}
                        {/* single offer item */}
                        <div className="col-xl-6 col-lg-10 wow fadeInUp" data-wow-delay=".6s">
                            <div className="single__offer">
                                <div className="single__offer__image">
                                    <img
