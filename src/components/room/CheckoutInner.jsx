...
function CheckoutInner() {
    return (
        <main className="ms-main rts-section-gap">
            <div className="ms-page-content">
                {/*================= Checkout Area Start =================*/}
                <article
                    id="post-284"
                    className="page checkout-area type-page status-publish hentry"
                >
                    <div className="ms-sp--header container">
                                            ...
                                            <div id="payment" className="woocommerce-checkout-payment">
                                                <div className="form-row place-order">
                                                    <div className="ms-proceed-to-checkout wc-proceed-to-checkout">
                                                        <Link to="#" className="theme-btn btn-style sm-btn fill">
                                                            <span>
